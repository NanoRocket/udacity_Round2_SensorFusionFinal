...
class Association:
    ...
    def associate(self, track_list, meas_list, KF):
        ...
        #   on Mahalanobis distance (see below) for all tracks and all measurements
        #   Also, use the gating() function to check if a measurement lies inside a 
        #   track's gate. If not, the function shall return False and the entry in 
        #   association_matrix shall be set to infinity. From misc/params.py, 
        #   you should load the parameter gating_threshold.
        # - update list of unassigned measurements and unassigned tracks  to include 
        #   the indices of all measurements and tracks that did not get associated.
        ############
    ...
    def get_closest_track_and_meas(self):
        ...
        #   and unassigned_meas
        # - return this track and measurement If no more association was found, 
        #   i.e. the minimum matrix entry is infinity, return numpy.nan for the 
