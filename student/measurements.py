...
class Sensor:
    ...
    def in_fov(self, x):
        ...
        # otherwise False.  Don't forget to transform from vehicle to sensor coordinates first. 
        # The sensor's field of view is given in the attribute fov.
        ############
...
class Measurement:
    ...
    def __init__(self, num_frame, z, sensor):
        ...
        if sensor.name == 'lidar':
            ...
            # Here I basically copied the lidar code above and changed the 
            # variables to the camera ones 
            ############
